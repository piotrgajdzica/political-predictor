...
from political_predictor.predictor import SentimentTagger, PoliticalViewsTagger
from political_predictor.train.db.dao import select_sample_tweets_no_sentiment_no_political_views, \
    count_tweets_no_sentiment_no_political_views
from political_predictor.train.db.sentiment_helpers import tweet_prediction_bulk_update

if __name__ == '__main__':

    sentiment_classifier = SentimentTagger()
    political_classifier = PoliticalViewsTagger()
    batch_size = 10000
